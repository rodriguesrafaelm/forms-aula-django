...
class PassagemForms(forms.ModelForm):
    ...
    def clean(self):
        ...
        data_ida = self.changed_data.get('data_ida')
        data_volta = self.changed_data.get('data_volta')        
        data_pesquisa = self.changed_data.get('data_pesquisa')
        lista_de_erros = {}
        ...
        ida_maior_que_volta(data_ida, data_volta, lista_de_erros)
        ida_maior_que_hoje(data_ida, data_pesquisa, lista_de_erros)
